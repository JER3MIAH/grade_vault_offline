...
class LicenseManagementScreenArgs {
  final Function(dynamic)? onComplete;
  final bool showSkip;

  const LicenseManagementScreenArgs({this.onComplete, this.showSkip = true});
}

class LicenseManagementScreen extends HookWidget {
  final LicenseManagementScreenArgs args;

  const LicenseManagementScreen({super.key, required this.args});
            ...
            child: Column(
              children: [
                ...
                if (decryptedDetails.value != null)
                  ElevatedButton(
                    onPressed: () =>
                        args.onComplete?.call(decryptedDetails.value),
